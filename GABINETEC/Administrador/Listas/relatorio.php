...
<html lang="pt-br">
  ...
  <div class="container"> 
		<header>
		<h1 id="title">Relatório de Compras</h1>
		<div class="acoes">
		...
		<?php
			foreach($vendas as $vend) {
				...
				echo "<td>$valor</td>";
				echo "<td>$situacao</td>";
				echo "<td class='op'><a title='Excluir' href='Deletar/tb_delete_relatorio.php?id_venda=$id&data_compra=$data&situacao=$situacao'><i class='fa fa-trash'></i></a></td>";
				echo "</tr>";
				echo "</tbody>";
